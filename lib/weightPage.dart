...
class _weightPageState extends State<weightPage> {
  ...
  String selectedUnit1 = 'Gram';
  double inputValue = 0.0;
  double result = 0.0;

  void convert() {
    if (selectedUnit == 'Kilogram') {
      if (selectedUnit1 == 'Gram') {
        result = inputValue * 1000;
      } else if (selectedUnit1 == 'Pound') {
        result = inputValue * 2.20462;
      }
    } else if (selectedUnit == 'Gram') {
      if (selectedUnit1 == 'Kilogram') {
        result = inputValue / 1000;
      } else if (selectedUnit1 == 'Pound') {
                  ...
                  children: [
                    Padding(
                      ...
                      child: DropdownButton<String>(
                        ...
                        items: <String>['Kilogram', 'Gram', 'Pound']
                            .map((String value) {
